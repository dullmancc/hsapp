 ...
 */
//const actionUrl = "http://193.112.12.241/HSWebApi/";
//const actionUrl = "http://localhost:1857/";
@IonicPage()
@Component({
  selector: 'page-login',
...
export class LoginPage {
  ...
  MyAccounts(Sno,loader){
    ...
    let headers = new HttpHeaders({"Accept" :"*/*","Content-Type":"application/x-www-form-urlencoded;charset=UTF-8",
      ...
      //this.httpc.get(actionUrl+'api/UserInfo/GetInfo?UserName='+Sno,{headers}).subscribe( res=>{
